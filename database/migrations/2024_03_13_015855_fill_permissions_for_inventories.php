...
class FillPermissionsForInventories extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInventories constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Inventories Module' => 'inventories',
            'List All Inventories' => 'inventories.index',
            'Create New Inventories' => 'inventories.create',
            'View Any Inventory' => 'inventories.show',
            'Edit or Update a Single Inventory' => 'inventories.edit',
            'Delete Inventories' => 'inventories.delete',
        ]);

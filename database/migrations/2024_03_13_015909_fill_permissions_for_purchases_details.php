...
class FillPermissionsForPurchasesDetails extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPurchasesDetails constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Purchases Detail Module' => 'purchases-details',
            'List All Purchases Detail' => 'purchases-details.index',
            'Create New Purchases Detail' => 'purchases-details.create',
            'View Any Purchases Detail' => 'purchases-details.show',
            'Edit or Update a Single Purchases Detail' => 'purchases-details.edit',
            'Delete Purchases Detail' => 'purchases-details.delete',
        ]);

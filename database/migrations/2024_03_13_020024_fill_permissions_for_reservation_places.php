...
class FillPermissionsForReservationPlaces extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReservationPlaces constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Reservation Places Module' => 'reservation-places',
            'List All Reservation Places' => 'reservation-places.index',
            'Create New Reservation Places' => 'reservation-places.create',
            'View Any Reservation Place' => 'reservation-places.show',
            'Edit or Update a Single Reservation Place' => 'reservation-places.edit',
            'Delete Reservation Places' => 'reservation-places.delete',
        ]);

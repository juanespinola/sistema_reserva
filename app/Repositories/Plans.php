...
{
    private Plan $model;
    public static function init(Plan $model): Plans
    {
        $instance = new self;
    ...
    public static function store(object $data): Plan
    {
        $model = new Plan((array) $data);
                // Save Relationships
    ...
    public function update(object $data): Plan
    {
    ...
    public static function dtColumns() {
        $columns = [
            ...
            Column::make("plan_name")->className('min-desktop-lg'),
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Plan $model) {
                $actions = '';

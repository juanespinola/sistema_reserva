...
class Suppliers
{
    ...
    public static function init(Supplier $model): Suppliers
    {
        $instance = new self;
    ...
    public static function store(object $data): Supplier
    {
        $model = new Supplier((array) $data);
                // Save Relationships
    ...
    public function update(object $data): Supplier
    {
    ...
    public static function dtColumns() {
        $columns = [
            ...
            Column::make("contact_name")->className('min-desktop-lg'),
            Column::make("phone_name")->className('min-desktop-lg'),
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Supplier $model) {
                $actions = '';

...
class Ratings
{
    ...
    public static function init(Rating $model): Ratings
    {
        $instance = new self;
    ...
    public static function store(object $data): Rating
    {
        $model = new Rating((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): Rating {
        //Fetch relationships
                $this->model->load([
            'customer',
            'reservationPlace',
    ...
    public function update(object $data): Rating
    {
    ...
    public static function dtColumns() {
        $columns = [
            ...
            Column::make("rating_value")->className('min-desktop-lg'),
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Rating $model) {
                $actions = '';

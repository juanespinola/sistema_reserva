...
class Customers
{
    ...
    public static function init(Customer $model): Customers
    {
        $instance = new self;
    ...
    public static function store(object $data): Customer
    {
    ...
    public function update(object $data): Customer
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Customer $model) {
                $actions = '';

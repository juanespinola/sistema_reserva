...
class Transactions
{
    ...
    public static function init(Transaction $model): Transactions
    {
        $instance = new self;
    ...
    public static function store(object $data): Transaction
    {
        $model = new Transaction((array) $data);
                // Save Relationships
    ...
    public function update(object $data): Transaction
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Transaction $model) {
                $actions = '';

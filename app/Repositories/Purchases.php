...
class Purchases
{
    ...
    public static function init(Purchase $model): Purchases
    {
        $instance = new self;
    ...
    public static function store(object $data): Purchase
    {
        $model = new Purchase((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): Purchase {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): Purchase
    {
    ...
    public static function dtColumns() {
        $columns = [
            ...
            Column::make("purchase_date")->className('min-desktop-lg'),
            Column::make("purchase_time")->className('min-desktop-lg'),
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Purchase $model) {
                $actions = '';

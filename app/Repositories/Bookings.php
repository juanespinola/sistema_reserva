...
class Bookings
{
    ...
    public static function init(Booking $model): Bookings
    {
        $instance = new self;
    ...
    public static function store(object $data): Booking
    {
        $model = new Booking((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): Booking {
        //Fetch relationships
                $this->model->load([
            'customer',
            'reservationPlace',
    ...
    public function update(object $data): Booking
    {
    ...
    public static function dtColumns() {
        $columns = [
            ...
            Column::make("start_datetime_booking")->className('min-desktop-lg'),
            Column::make("end_datetime_booking")->className('min-desktop-lg'),
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Booking $model) {
                $actions = '';

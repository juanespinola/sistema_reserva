...
class ReservationPlaces
{
    private ReservationPlace $model;
    public static function init(ReservationPlace $model): ReservationPlaces
    {
        $instance = new self;
    ...
    public static function store(object $data): ReservationPlace
    {
        $model = new ReservationPlace((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): ReservationPlace {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): ReservationPlace
    {
    ...
    public static function dtColumns() {
        $columns = [
            ...
            Column::make("description")->className('min-desktop-lg'),
            Column::make("location")->className('min-desktop-lg'),
            Column::make("capacity")->className('min-desktop-lg'),
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (ReservationPlace $model) {
                $actions = '';

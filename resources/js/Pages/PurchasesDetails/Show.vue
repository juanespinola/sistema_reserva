<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.purchases-details.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Purchases Detail
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-purchases-details-form :model="model"></show-purchases-details-form>
            </div>
        </div>
...
<script>
    ...
    import ShowPurchasesDetailsForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowPurchasesDetail",
        components: {
            InertiaButton,
            JigLayout,

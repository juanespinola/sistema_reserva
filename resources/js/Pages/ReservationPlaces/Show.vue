<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.reservation-places.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Reservation Place
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-reservation-places-form :model="model"></show-reservation-places-form>
            </div>
        </div>
...
<script>
    ...
    import ShowReservationPlacesForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowReservationPlace",
        components: {
            InertiaButton,
            JigLayout,

    ...
    <jig-layout>
        <template #header>
            ...
            >
                ...
                ><i class="fas fa-arrow-left"></i> Back | Details of Transaction
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-transactions-form :model="model"></show-transactions-form>
            </div>
        </div>
...
<script>
    ...
    import ShowTransactionsForm from "./ShowForm.vue"

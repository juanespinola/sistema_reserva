<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.sales-details.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Sales Detail
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-sales-details-form :model="model"></show-sales-details-form>
            </div>
        </div>
...
<script>
    ...
    import ShowSalesDetailsForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowSalesDetail",
        components: {
            InertiaButton,
            JigLayout,
